...
# 下载最新版本的 executor
echo "正在下载 v58 executor..."
wget -O executor-linux-0.58.0.tar.gz https://github.com/t3rn/executor-release/releases/download/v0.58.0/executor-linux-v0.58.0.tar.gz || { echo "下载失败"; exit 1; }

# 解压文件
echo "正在解压文件..."
tar -xzf executor-linux-0.58.0.tar.gz || { echo "解压失败"; exit 1; }
rm executor-linux-0.58.0.tar.gz
